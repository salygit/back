...
public class CodeDOM {
     ...
     * 数据连接相关
     */
    private static final String URL = "jdbc:mysql://192.168.64.128:3306/test?serverTimezone=GMT%2B8&characterEncoding=utf-8";
    private static final String USERNAME = "root";
    private static final String PASSWORD = "Yuwenjing2019@";
